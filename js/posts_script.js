document.addEventListener("DOMContentLoaded", function() {
  ...
  function clearFormFields(form, buttons, selected) {
  ...
  function handleFormSubmission(form, facultyInput, categoryInput, submitButton) {
      ...
      submitButton.addEventListener("click", function(event) {
          ...
          if (nameInput.value === "") {
              ...
              showAlert("Пожалуйста, сделайте выбор.");
          } else if (!dateInput.value) {
              showAlert("Пожалуйтса, выберите дату.");
          } else if (!messageInput.value.trim()) {
              showAlert("Пожалуйста, напишите содержание.");
          } else {
            clearFormFields(form, buttons, selected);
          }
          */
          createPost();
